...
//upload this sketch to Arduino board, and run the program. 
//If your robot moving in a wrong way,try changing the polarities of your motor, or changing the state values where mentioned in the source code.
